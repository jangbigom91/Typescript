...
function sendGreeting1 (message1: string, userName1: string):void {
...
function sendGreeting2 (message2: string, userName2?: string):void {
...
// 매개변수 뒤에 값을 지정해주면 됨
function sendGreeting3 (message3 = 'Hello', userName3 = 'there'):void {
...
// 화살표 함수 =>
const sendGreeting4 = (message4 = 'Hello', userName4 = 'there'):
void => console.log (`${message4}, ${userName4}`);
